...
public class GenesDao {
	...
	public List<Adiacenza> getArchi(){
		String sql = "SELECT g1.Chromosome AS c1,g2.Chromosome AS c2,SUM(DISTINCT Expression_Corr) AS peso "
				+ "FROM genes g1,genes g2,interactions i "
				+ "WHERE g1.Chromosome<>g2.Chromosome AND "
				+ "g1.GeneID=i.GeneID1 AND g2.GeneID=i.GeneID2 "
